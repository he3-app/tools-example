...
import messages from './dify-dream-lang.json';
const { t } = useI18n({
...
async function getAnswer() {
  ...
  try {
    ...
    const url = 'https://api.test.he3.app/v1/langgenius/completion/deram';
    // const url = 'http://127.0.0.1:8080/v1/langgenius/completion/deram';
