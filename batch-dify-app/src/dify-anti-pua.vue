...
import messages from './dify-anti-pua-lang.json';
const { t } = useI18n({
...
async function getAnswer() {
  ...
  try {
    ...
    // const url = 'https://service-fphnil1i-1309234724.hk.apigw.tencentcs.com/yourapi';
    const url = 'https://api.test.he3.app/v1/langgenius/completion/pua';
